 ...
 * */
	...
	switch(p) {
		case TMS:
			if (val)	writel(0x00000002, GPSR0);
			else		writel(0x00000002, GPCR0);
			break;
		case TDI:
			if (val)	writel(0x00400000, GPSR2);
			else		writel(0x00400000, GPCR2);
			break;
		case TCK:
			if (val)	writel(0x00080000, GPSR2);
			else		writel(0x00080000, GPCR2);
			break;
		default:
			break;
	}
