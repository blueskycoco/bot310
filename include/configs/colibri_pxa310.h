...
#undef	CONFIG_LZMA			/* LZMA compression support */
...
#define	CONFIG_PXA3XX_CPUFREQ_AUTO
...
#define	CONFIG_SYS_SDRAM_BASE		0xa0000000 /* CS0 */
#define	CONFIG_SYS_SDRAM_SIZE		0x04000000 /* 64 MB DRAM */
